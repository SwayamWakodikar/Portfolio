  ...
  const projects = [
    {
      ...
      title: "LeetCode",
      description:
        "https://leetcard.jacoblin.cool/swayam_w06?theme=dark&font=Noto%20Sans%20Glagolitic&ext=heatmap",
    ...
    },
    {
      id: 2,
      title: "Auth WebApp",
      description: "https://nirzak-streak-stats.vercel.app/?user=SwayamWakodikar&theme=tokyonight&hide_border=false",
      tech: [
        "React",
        "MongoDB",
        "JWT",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-indigo-100 text-lg max-w-2xl mx-auto">
            Some of my Stats on different platforms showcasing my skill in the fields
          </p>
        </div>
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="relative p-6">
                ...
                <img src={project.description} alt="" />
