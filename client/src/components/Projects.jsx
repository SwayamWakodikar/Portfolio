      ...
      <AnimatePresence>
        {selectedProject && (
          <>
            ...
            >
              <div
                className="relative bg-[#0a0a0a]/95 backdrop-blur-xl rounded-3xl border border-white/10 max-w-6xl w-full max-h-[85vh] pointer-events-auto shadow-2xl shadow-cyan-500/20 overflow-hidden"
                onClick={(e) => e.stopPropagation()}
              >
                {/* Close Button */}
                <button
                  onClick={() => setSelectedProject(null)}
                  className="absolute top-4 right-4 z-10 p-2 bg-white/10 hover:bg-white/20 rounded-full transition-colors border border-white/20"
                >
                  ...
                  <div className="w-full md:w-1/2 p-6 md:p-8 flex flex-col justify-between">
                    <div>
                      <div className="flex flex-wrap justify-between items-start gap-3 mb-4">
                        ...
                        <span className="px-3 py-1.5 bg-cyan-500/20 text-cyan-200 text-xs font-semibold rounded-full border border-cyan-500/30 whitespace-nowrap">
                      ...
                      <div className="mb-5">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedProject.tech.map((tech, index) => (
                            <span
                              key={index}
                              className="px-3 py-1.5 bg-cyan-900/20 text-cyan-200 text-xs font-medium rounded-lg border border-cyan-500/30"
                            >
                              {tech}
                            </span>
                          ))}
                    ...
                    <div className="flex flex-wrap gap-3 pt-5 border-t border-white/10">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-cyan-600 to-blue-600 text-white rounded-xl hover:scale-105 transition-all font-medium text-sm shadow-lg shadow-cyan-500/30"
                      >
