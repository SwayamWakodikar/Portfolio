        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-start gap-12">
          ...
          <div className="flex flex-col items-center lg:items-start w-full lg:w-auto">
            <img
              src={assets[0]}
              alt="Profile"
              className="h-64 w-64 lg:h-80 lg:w-80 rounded-full object-cover border-4 border-white/10 shadow-2xl mb-6"
            />
            <div className="text-center lg:text-left">
              <h1 className="text-3xl lg:text-5xl font-extrabold text-white tracking-tight drop-shadow-lg mb-2">
                Swayam Wakodikar
              </h1>
              <div className="text-xl lg:text-2xl font-semibold text-cyan-200/80">
          ...
          <div className="flex-1 w-full lg:w-auto">
            <div className=" bg-transparent rounded-2xl shadow-xl p-8 border ">
              <div className="space-y-10">
                <h2 className="text-4xl lg:text-5xl font-bold text-white mb-8 relative inline-block drop-shadow-md">
                  About Me
                  <span className="absolute -bottom-3 left-0 w-1/3 h-1.5 bg-cyan-500 rounded-full"></span>
                </h2>

                <p className="text-2xl lg:text-3xl text-gray-400/90 leading-relaxed font-light">
